...
| **04** legal<br>*in progress* | Contract checklist, scope-of-work template and NDA draft written. Three public pages live. **16 Aug** | Two things. Publish a research-and-marketing section in the privacy policy — Article 14 requires it before any lead is emailed, and `LIA-2026-08-v1` is blocked on it. Then solicitor review, which **waits on budget**. Nothing here has been reviewed and must not be described as if it has. |
