...
const DOCS = {
  privacy: {
    ...
    body: [
      ...
      ['The assistant on this site', [
        'This site has an assistant you can type questions into. Its answers are generated by an AI language model — they are not written by a person, and no one at n.abl reads them before you do. It can be wrong. Nothing it says is advice, a quote, or a commitment we are bound by.',
        'What gets sent. The message you type, the earlier messages in that same conversation, and a written summary of what n.abl does. That summary is a file we maintain by hand. The assistant has no connection to our database: it cannot see client records, quotes, documents, or anything you have previously sent us.',
        'What does not get sent. Anything that identifies you. Not your name, not your email address, not your IP address, and no identifier that would let one conversation be tied to another one or to a person. We do not keep a copy of the conversation — closing the tab ends it, and there is nothing afterwards for us to read.',
        'Who processes it. Groq, acting as our processor on our instructions, at a facility in the United States. That transfer relies on the UK International Data Transfer Agreement.',
        'Using it is optional. Everything the assistant knows is also written on this site, and the discovery-call form goes nowhere near it. As with any chat box on any website, please do not type anything into it that you would not put in an email to someone you have not met.',
      ]],
      ...
      ['Service providers', [
        ...
        'Groq — runs the AI model behind the assistant on this site, if you use it. What is and is not sent to it is set out under “The assistant on this site” above.',
  ...
  terms: {
    ...
    body: [
      ...
      ['Automated answers on this website', [
        'Part of this website is answered by an AI assistant. Its replies are produced automatically by a language model and are not reviewed by a person before you read them.',
        'They are general information only. They are not advice, not an offer, and not a quote. Nothing the assistant says forms part of a contract between us, binds us to a price or a timescale, or overrides a quote, statement of work or other document we have signed. Where the two disagree, the signed document is the one that counts.',
        'Automated answers can be wrong or out of date. Please confirm anything you intend to act on with us at hello@nabl.agency first.',
      ]],
  ...
  cookies: {
    ...
    body: [
      ...
      ['What we do store', [
        ...
        'The assistant. Nothing again. Your conversation with the AI assistant exists only in the page you have open. It is not written to a cookie, not written to storage, and not kept by us after you close the tab.',
      ]],
      ['Third parties', [
        'Submitting the discovery-call form sends its contents to Web3Forms so the message reaches our inbox. Messages you type into the AI assistant go to Groq, which generates the reply. The site is served by Cloudflare, and the anonymous usage events described in our privacy policy go to our own Supabase project. None of the four is used to set a tracking cookie on this site.',
      ]],
      ['Controlling storage', [
