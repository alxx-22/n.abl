  ...
  privacy: {
    ...
    body: [
      ...
      ['If we contacted you first', [
        ...
        'What we hold. Your company name, its registered and trading address, what it does, a business email address, and a note of why we thought the service was relevant to you. Where a name reaches us it is a business name or a role — we do not build a profile, we do not track you across the web, and we do not enrich our records from data brokers.',
        'Where we got it. From registers the government publishes as open data for anyone to download — principally the Companies House register of companies and the Food Standards Agency food hygiene register — and from your own company website. We download the files those bodies publish for exactly this purpose. We do not buy or rent marketing lists, we do not obtain data from brokers, and we do not take data from any site whose terms forbid it.',
        'How much of it. We hold register entries for tens of thousands of businesses across our region, because that is how the registers are published — as whole files, not as single lookups. Holding a public register entry is not the same as contacting you, and the two numbers are nothing like each other: we write to a small fraction of that list, chosen deliberately. If we have not written to you, all we hold is the entry the register already publishes about your company.',
        'Why. To introduce a service we believe is relevant to your business. Our lawful basis is legitimate interests, and we have completed and recorded a written assessment weighing that interest against your rights before contacting anyone. It sets a cap on how many businesses we may approach and it is reviewed on a fixed date. We contact only registered companies, and only where we can say something specific about why we approached you.',
