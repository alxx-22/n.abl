...
const SHOW = [
  ...
  { id: 'stat', dur: 3.4, cell: 'num', cam: { x: 1050, y: 1495, z: 0.62 },
  ...
  { id: 'hours', dur: 3.0, cell: 'hours', cam: { x: 3150, y: 1462, z: 0.62 },
  ...
  { id: 'desk', dur: 3.0, cell: 'tuesday', cam: { x: 1050, y: 4763, z: 0.62 },
  ...
  { id: 'twice', dur: 2.8, cell: 'tuesday', cam: { x: 1050, y: 5411, z: 0.62 },
    say: 'And somebody types it into the second system.' },

  /* DOWN — to the thing that stops it. */
  { id: 'label', dur: 2.2, cell: 'fix', cam: { x: 1050, y: 7100, z: 0.62 },
    say: 'Set up once.' },

  { id: 'build', dur: 4.0, cell: 'fix', cam: { x: 1050, y: 8553, z: 0.60 }, scene: 'automation', from: 0.6,
    say: 'The steps that repeat between your systems, connected once and then left to run.' },

  /* IN — on the part that matters. */
  /* Measured: the label ends at canvas y7215 and the drawn scene runs
     7945-9161. At y8100/z0.95 the frame top landed on 7090 and cut the
     label mid-word, which reads as an accident rather than as having
     moved past it. Centred on the flow instead, label cleanly out. */
  { id: 'runs', dur: 3.0, cell: 'fix', cam: { x: 1050, y: 8290, z: 1.15 }, scene: 'automation', from: 6.4,
    say: 'Nobody opens it again.' },

  /* ACROSS — off the work and onto the name. */
  { id: 'sign', dur: 3.6, cell: 'sign', cam: { x: 3150, y: 8500, z: 0.60 },
